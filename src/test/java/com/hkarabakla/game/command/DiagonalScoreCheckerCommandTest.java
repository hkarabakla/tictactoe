...
public class DiagonalScoreCheckerCommandTest {
    private Command underTest;

    @Before
    public void setUp() {
        this.underTest = new DiagonalScoreCheckerCommand();
    }
...
//                ----+---+---+---+
        ...
        slots[1][1] = Slot.SlotBuilder.builder().horizontal(1).vertical(1).value('O').build();
        ...
        slots[2][2] = Slot.SlotBuilder.builder().horizontal(2).vertical(2).value('O').build();
        ...
        boardMock.setLastPlayVertical(2);
        ...
        // then
        assertTrue(bo.toString().contains("WINNER"));
    }
}
