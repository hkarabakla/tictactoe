...
public class PlayerActionCommandTest {
    ...
    @Before
    public void setUp() {
        this.underTest = new PlayerActionCommand();
    }
...
//                ----+---+---+---+
        ...
        slots[0][2] = Slot.SlotBuilder.builder().horizontal(0).vertical(2).value('O').build();
        ...
        slots[2][2] = Slot.SlotBuilder.builder().horizontal(2).vertical(1).build();
        ...
        boardMock.setLastPlayer(player2);
        boardMock.setLastPlayHorizontal(2);
        boardMock.setLastPlayVertical(1);
        ...
        // then
        assertTrue(game.getBoard().getEmptySlots().isEmpty());
    }
}
